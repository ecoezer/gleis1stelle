...
const DELIVERY_ZONES = {
  '21435-ashausen': { label: '21435, Ashausen', minOrder: 14, fee: 1.5 },
  '21435-stelle': { label: '21435, Stelle', minOrder: 16, fee: 2 },
  '21423-scharmbeck': { label: '21423, Scharmbeck', minOrder: 16, fee: 2.25 },
  '21423-grevelau': { label: '21423, Grevelau, Winsen (Luhe)', minOrder: 25, fee: 2.5 },
  '21423-pattensen': { label: '21423, Pattensen, Winsen (Luhe)', minOrder: 20, fee: 2.5 },
  '21423-bahlburg': { label: '21423, Bahlburg, Winsen (Luhe)', minOrder: 30, fee: 3 },
  '21423-luhdorf': { label: '21423, Luhdorf, Winsen (Luhe)', minOrder: 30, fee: 3.25 },
  '21220-holtorfsloh': { label: '21220, Holtorfsloh, Seevetal', minOrder: 30, fee: 3.25 },
  '21220-ohlendorf': { label: '21220, Ohlendorf, Seevetal', minOrder: 30, fee: 3.25 },
  '21220-ramelsloh': { label: '21220, Ramelsloh, Seevetal', minOrder: 40, fee: 4 },
  '21220-horst': { label: '21220, Horst, Seevetal', minOrder: 45, fee: 4.25 },
  '21220-maschen': { label: '21220, Maschen, Seevetal', minOrder: 40, fee: 4 },
  '21217-hoersten': { label: '21217, Hörsten, Seevetal', minOrder: 40, fee: 4 },
  '21423-stoeckte': { label: '21423, Stöckte, Winsen (Luhe)', minOrder: 30, fee: 3 }
} as const;
